        ...
        <tr>
            ...
            <td style="padding-left: 50px">
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right"><img src="index.php?controller=backend/user&action=captcha" width="145" height="20" alt="CAPTCHA" border="1" onclick= this.src="index.php?controller=backend/user&action=captcha&r=" + Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
                        </td>
                    </tr>
